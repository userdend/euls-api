...
- The extracted values are mapped into the “Subject” model and appended to the List<Subject> before being sent as a response to this endpoint.
...
- The filtered information is mapped into the “Timetable” model and appended to the List<Timetable> before being sent as a response from this endpoint.